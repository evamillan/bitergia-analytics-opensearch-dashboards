...
RUN opensearch-dashboards-plugin install "https://github.com/evamillan/bitergia-analytics-plugin/releases/download/0.18.0-rc.1/bitergia_analytics-0.18.0_2.7.0.zip"
