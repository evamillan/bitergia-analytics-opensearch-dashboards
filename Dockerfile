...
RUN opensearch-dashboards-plugin install "https://github.com/evamillan/bitergia-analytics-plugin/releases/download/0.18.2/bitergia_analytics-0.18.2_2.7.0.zip"
